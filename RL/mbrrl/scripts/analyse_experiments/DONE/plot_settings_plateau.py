...
settings['folders_to_analyse'].append(root_folder+'v0-first-order-lfa/PRL/AA-5')
settings['folders_to_analyse'].append(root_folder+'v0-first-order-lfa/MFFS/adaptive-nil/decoupled-weights/AA-5')
settings['folders_to_analyse'].append(root_folder+'v0-first-order-lfa/MQTE/AA-5')
if include_MQTE_ablation:
    settings['folders_to_analyse'].append(root_folder+'v0-first-order-lfa/MFFS/adaptive-nil/MQTE-true/AA-5')
...
settings['folders_to_analyse'].append(root_folder+'v0-first-order-lfa/PRL/RC-6')
settings['folders_to_analyse'].append(root_folder+'v0-first-order-lfa/MFFS/adaptive-nil/decoupled-weights/RC-6')
settings['folders_to_analyse'].append(root_folder+'v0-first-order-lfa/MFFS/adaptive-nil/RC-6')
if include_MQTE_ablation:
    settings['folders_to_analyse'].append(root_folder+'v0-first-order-lfa/MFFS/adaptive-nil/MQTE-true/RC-6')
    settings['folders_to_analyse'].append(root_folder+'v0-first-order-lfa/MQTE/RC-6-learned')
...
settings['folders_to_analyse'].append(root_folder+'v0-first-order-lfa/PRL/TT-6')
settings['folders_to_analyse'].append(root_folder+'v0-first-order-lfa/MFFS/adaptive-nil/decoupled-weights/TT-6')
settings['folders_to_analyse'].append(root_folder+'v0-first-order-lfa/MQTE/TT-6')
if include_MQTE_ablation:
    settings['folders_to_analyse'].append(root_folder+'v0-first-order-lfa/MFFS/adaptive-nil/MQTE-true/TT-6')
...
settings['folders_to_analyse'].append(root_folder+'v0-first-order-lfa/PRL/TF-d2')
settings['folders_to_analyse'].append(root_folder+'v0-first-order-lfa/MFFS/adaptive-nil/decoupled-weights/TF-d2')
settings['folders_to_analyse'].append(root_folder+'v0-first-order-lfa/MQTE/TF-d2')
if include_MQTE_ablation:
    settings['folders_to_analyse'].append(root_folder+'v0-first-order-lfa/MFFS/adaptive-nil/MQTE-true/TF-d2')
    settings['folders_to_analyse'].append(root_folder+'v0-first-order-lfa/MQTE/TF-d2-learned')

if include_MQTE_ablation:
    reorder_by_legend = {
        'default': [
            ['Double_Q-Learning2, FA=LFA-ALL_N, FL=iFDD+', 'MQTE=0'],
            ['Double_Q-Learning2, FA=LFA-ALL_L2SPN (', 'MQTE=0'],
            ['Double_Q-Learning2, FA=LFA-ALL_L2SPND', 'MQTE=0'],
            ['Dual-Double_Q-Learning2~D', 'MQTE=0'],
            ['Double_Q-Learning2, FA=LFA-ALL_L2SPN (', 'MQTE=3'],
            ['dummy', 'MDL=Dbn', 'Double_Q-Learning2, FA=LFA-ALL_L2SPN (', 'MQTE=3'],
            ['MDL=Dbn', 'Double_Q-Learning2, FA=LFA-ALL_L2SPN (', 'MQTE=3'],
        ],
        'recon2_mdp': [
            ['Double_Q-Learning2, FA=LFA-ALL_N, FL=iFDD+', 'MQTE=0'],
            ['Double_Q-Learning2, FA=LFA-ALL_L2SPN (', 'MQTE=0'],
            ...
            ['Dual-Double_Q-Learning2~D', 'MQTE=0'],
            ['Double_Q-Learning2, FA=LFA-ALL_L2SPN (', 'MQTE=3'],
            ['MDL=Dbn', 'Learned', 'Double_Q-Learning2, FA=LFA-ALL_L2SPN (', 'MQTE=3'],
            ['MDL=Dbn', 'Ground-Truth', 'Double_Q-Learning2, FA=LFA-ALL_L2SPN (', 'MQTE=3'],
        ],
        'tiago_fetch_mdp': [
            ['Double_Q-Learning2, FA=LFA-ALL_N, FL=iFDD+', 'MQTE=0'],
            ['Double_Q-Learning2, FA=LFA-ALL_L2SPN (', 'MQTE=0'],
...
if include_MQTE_ablation:
    settings['legend_labels'] = [
        r'$\widetilde{Q}^{gnd}$',                                           # baseline
        r'$\widetilde{Q}^{fo}$',                                            # baseline
        r'$\widetilde{Q}^{fo} $ (DW)',                                      # decoupled weights
        r'$\widetilde{Q}^{gnd} + \widetilde{Q}^{fo}$',                      # online RL with ensemble
        r'$\widetilde{Q}^{fo}$ (MQTE, MLM)',                                # MQTE
        r'$\widetilde{Q}^{fo}$ (MQTE, Learned DBN)',                        # MQTE
        r'$\widetilde{Q}^{fo}$ (MQTE, Ground Truth DBN)']                   # MQTE
else:
    settings['legend_labels'] = [
        r'$\widetilde{Q}^{gnd}$',                                           # baseline
        r'$\widetilde{Q}^{fo}$',                                            # baseline
        r'$\widetilde{Q}^{fo} $ (DW)',                                      # decoupled weights
        r'$\widetilde{Q}^{fo}$ (MQTE)',                                     # MQTE
        r'$\widetilde{Q}^{gnd} + \widetilde{Q}^{fo}$']                      # online RL with ensemble
y_lim = None
# y_lim = (-300, -100, 50)
