...
# settings['folders_to_analyse'].append(root_folder+'v1-generalised-learning/DYNA/DYNA-learned-100/HRI-1')
# settings['folders_to_analyse'].append(root_folder+'v1-generalised-learning/DYNA/DYNA-learned-100/RC-6')
# settings['folders_to_analyse'].append(root_folder+'v1-generalised-learning/DYNA/DYNA-learned-100/TF-d2')
# settings['folders_to_analyse'].append(root_folder+'v1-generalised-learning/DYNA/DYNA-learned-100/TS-de4')

settings['folders_to_analyse'].append(root_folder+'v1-generalised-learning/DYNA/DYNA-learned-500/HRI-1')
settings['folders_to_analyse'].append(root_folder+'v1-generalised-learning/DYNA/DYNA-learned-500/RC-6')
settings['folders_to_analyse'].append(root_folder+'v1-generalised-learning/DYNA/DYNA-learned-500/TF-d2')
settings['folders_to_analyse'].append(root_folder+'v1-generalised-learning/DYNA/DYNA-learned-500/TS-de4')
...
settings['folders_to_analyse'].append(root_folder+'v1-generalised-learning/DYNA/DYNA-learned-3000/HRI-1')
settings['folders_to_analyse'].append(root_folder+'v1-generalised-learning/DYNA/DYNA-learned-3000/RC-6')
settings['folders_to_analyse'].append(root_folder+'v1-generalised-learning/DYNA/DYNA-learned-3000/TF-d2')
settings['folders_to_analyse'].append(root_folder+'v1-generalised-learning/DYNA/DYNA-learned-3000/TS-de4')
...
settings['plot_settings'] = {
    ...
    'reorder_by_legend': {
        'default': [
            # ['MDL=List', 'FA=LFA-ALL_N', 'SP=disabled'],
            # ['MDL=Dbn', 'FA=LFA-ALL_N', 'SP={500, 40}'],
            # ['MDL=Dbn', 'FA=LFA-ALL_N', 'SP={1000, 40}'],
            # ['MDL=Dbn', 'FA=LFA-ALL_N', 'SP={3000, 40}'],

            ['MDL=List', 'FA=LFA-ALL_L2SPN (CX', 'SP=disabled'],
            # ['MDL=Dbn', 'FA=LFA-ALL_L2SPN (CX', 'SP={100, 40}'],
            ['MDL=Dbn', 'FA=LFA-ALL_L2SPN (CX', 'SP={500, 40}'],
            ['MDL=Dbn', 'FA=LFA-ALL_L2SPN (CX', 'SP={1000, 40}'],
            ['MDL=Dbn', 'FA=LFA-ALL_L2SPN (CX', 'SP={3000, 40}']
        ],
