...
settings['folders_to_analyse'].append(root_folder+'v1-generalised-learning/DYNA/DYNA-learned-1000-poor-models/HRI-1')
settings['folders_to_analyse'].append(root_folder+'v1-generalised-learning/DYNA/DYNA-learned-1000-poor-models/RC-6')
settings['folders_to_analyse'].append(root_folder+'v1-generalised-learning/DYNA/DYNA-learned-1000-poor-models/TF-d2')
settings['folders_to_analyse'].append(root_folder+'v1-generalised-learning/DYNA/DYNA-learned-1000-poor-models/TS-de4')
...
# settings['legend_labels'] = [
#     r'$\widetilde{Q}^{gnd}$ ($N_{sim} = 0)$',
#     r'$\widetilde{Q}^{gnd}$ (T, $N_{sim} = 1000$)',
#     r'$\widetilde{Q}^{gnd}$ ($L \sim 50, N_{sim} = 1000$)',
#     r'$\widetilde{Q}^{gnd}$ ($L \sim 500, N_{sim} = 1000$)',
#     r'$\widetilde{Q}^{fo}$ ($N_{sim} = 0$)',
#     r'$\widetilde{Q}^{fo}$ (T, $N_{sim} = 1000)$)',
#     r'$\widetilde{Q}^{fo}$ ($L \sim 50, N_{sim} = 1000$)',
#     r'$\widetilde{Q}^{fo}$ ($L \sim 500, N_{sim} = 1000$)']
settings['legend_labels'] = [
    r'$\widetilde{Q}^{gnd}$ (T)',
    r'$\widetilde{Q}^{gnd}$ ($L \sim 50$)',
    r'$\widetilde{Q}^{gnd}$ ($L \sim 500$)',
    r'$\widetilde{Q}^{fo}$ (T)',
    r'$\widetilde{Q}^{fo}$ ($L \sim 50$)',
    r'$\widetilde{Q}^{fo}$ ($L \sim 500$)']
y_lim = None
# y_lim = (-300, -100, 50)
...
settings['plot_settings'] = {
    ...
    'reorder_by_legend': {
        'default': [
            ...
            ['MDL=Dbn', 'Ground-Truth', 'FA=LFA-ALL_N', 'SP={1000, 40}'],
            ['poor', 'MDL=Dbn', 'Learned', 'FA=LFA-ALL_N', 'SP={1000, 40}'],
            ['MDL=Dbn', 'Learned', 'FA=LFA-ALL_N', 'SP={1000, 40}'],
            # ['MDL=List', 'FA=LFA-ALL_L2SPN (CX', 'SP=disabled'],
            ['MDL=Dbn', 'Ground-Truth', 'FA=LFA-ALL_L2SPN (CX', 'SP={1000, 40}'],
            ['poor', 'MDL=Dbn', 'Learned', 'FA=LFA-ALL_L2SPN (CX', 'SP={1000, 40}'],
            ['MDL=Dbn', 'Learned', 'FA=LFA-ALL_L2SPN (CX', 'SP={1000, 40}'],
        ],
        'turtlebot_survey_mdp': [
            # ['MDL=List', 'FA=N', 'SP=disabled'],
            ['MDL=Dbn', 'Ground-Truth', 'FA=N', 'SP={1000, 40}'],
            ['poor', 'MDL=Dbn', 'Learned', 'FA=N', 'SP={1000, 40}'],
            ['MDL=Dbn', 'Learned', 'FA=N', 'SP={1000, 40}'],
            # ['MDL=List', 'FA=L2SPN (CX', 'SP=disabled'],
            ['MDL=Dbn', 'Ground-Truth', 'FA=L2SPN (CX', 'SP={1000, 40}'],
            ['poor', 'MDL=Dbn', 'Learned', 'FA=L2SPN (CX', 'SP={1000, 40}'],
            ['MDL=Dbn', 'Learned', 'FA=L2SPN (CX', 'SP={1000, 40}'],
        ],
        'tiago_hri': [
            # ['MDL=List', 'FA=N', 'SP=disabled'],
            ...
            ['MDL=Dbn', 'Learned', 'FA=N', 'SP={1000, 40}'],
            # ['MDL=List', 'FA=L2SPN (CX', 'SP=disabled'],
            ['MDL=Dbn', 'Latent', 'FA=L2SPN (CX', 'SP={1000, 40}'],
            ['poor', 'MDL=Dbn', 'Learned', 'FA=L2SPN (CX', 'SP={1000, 40}'],
            ['MDL=Dbn', 'Learned', 'FA=L2SPN (CX', 'SP={1000, 40}'],
        ]
    },
