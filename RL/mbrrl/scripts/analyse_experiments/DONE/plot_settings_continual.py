...
settings['folders_to_analyse'].append(root_folder+'v1-generalised-learning/continual-learning/HRI-1')
settings['folders_to_analyse'].append(root_folder+'v1-generalised-learning/continual-learning/RC-6')
settings['folders_to_analyse'].append(root_folder+'v1-generalised-learning/continual-learning/TF-d2')
settings['folders_to_analyse'].append(root_folder+'v1-generalised-learning/continual-learning/TS-de4')
settings['folders_to_analyse'].append(root_folder+'v1-generalised-learning/continual-learning/did-not-transfer-ground/HRI-1')
settings['folders_to_analyse'].append(root_folder+'v1-generalised-learning/continual-learning/did-not-transfer-ground/RC-6')
settings['folders_to_analyse'].append(root_folder+'v1-generalised-learning/continual-learning/did-not-transfer-ground/TF-d2')
settings['folders_to_analyse'].append(root_folder+'v1-generalised-learning/continual-learning/did-not-transfer-ground/TS-de4')
settings['folders_to_analyse'].append(root_folder+'v1-generalised-learning/continual-learning/did-not-transfer-intrinsic/HRI-1')
settings['folders_to_analyse'].append(root_folder+'v1-generalised-learning/continual-learning/did-not-transfer-intrinsic/RC-6')
settings['folders_to_analyse'].append(root_folder+'v1-generalised-learning/continual-learning/did-not-transfer-intrinsic/TF-d2')
settings['folders_to_analyse'].append(root_folder+'v1-generalised-learning/continual-learning/did-not-transfer-intrinsic/TS-de4')
...
settings['legend_labels'] = []
settings['legend_labels'] = [
    r'$\widetilde{Q}^{gnd}_{\bot}$',                                               # no transfer learning
    r'$\widetilde{Q}^{gnd}$',                                                      # transfer learning
    r'$\widetilde{Q}^{fo}$',                                                       # transfer learning
    r'$\widetilde{Q}^{fo} + \widetilde{Q}^{fo}_{int,\bot}$',                     # transfer learning but not intrinsic
    r'$\widetilde{Q}^{fo} + \widetilde{Q}^{fo}_{int}$',                            # transfer learning including intrinsic
    r'$\widetilde{Q}^{gnd} + \widetilde{Q}^{fo}$',                                 # transfer learning with ensemble
    r'$\widetilde{Q}^{gnd} + \widetilde{Q}^{fo} + \widetilde{Q}^{fo}_{int}$']      # transfer learning with ensemble and intrinsic
y_lim = None
# y_lim = (-300, -100, 50)
...
settings['plot_settings'] = {
    ...
    'reorder_by_legend': [
        ['Double_Q-Learning2', 'FA=LFA-ALL_N'],
        ['Double_Q-Learning2', 'FA=LFA-ALL_N', 'Import-Qfunction=True'],
        ['Double_Q-Learning2', 'FA=LFA-ALL_L2SPN', 'IR=disabled', 'Import-Qfunction=True'],
        ['Double_Q-Learning2', 'FA=LFA-ALL_L2SPN', 'IR=td_error', 'Import-Qfunction=True'],
        ['Double_Q-Learning2', 'FA=LFA-ALL_L2SPN', 'IR=td_error', 'Import-Qfunction=True', 'Import-Intrinsic=True'],
        ['Dual-Double_Q-Learning2~TLD', 'IR=disabled', 'Import-Qfunction=True', 'Import-Intrinsic=True'],
        ['Dual-Double_Q-Learning2~TLD', 'IR=td_error', 'Import-Qfunction=True', 'Import-Intrinsic=True'],
    ],
