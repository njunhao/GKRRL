...
# settings['folders_to_analyse'].append(root_folder+'v4-uct/PROST/HRI-2')
settings['folders_to_analyse'].append(root_folder+'v4-uct/PROST/HRI-3')
settings['folders_to_analyse'].append(root_folder+'v4-uct/PROST/RC-6')
settings['folders_to_analyse'].append(root_folder+'v4-uct/PROST/TF-d2')
settings['folders_to_analyse'].append(root_folder+'v4-uct/PROST/TS-de4')

# settings['folders_to_analyse'].append(root_folder+'v4-uct/MFRL/HRI-2')
settings['folders_to_analyse'].append(root_folder+'v4-uct/MFRL/HRI-3')
settings['folders_to_analyse'].append(root_folder+'v4-uct/MFRL/RC-6')
settings['folders_to_analyse'].append(root_folder+'v4-uct/MFRL/TF-d2')
settings['folders_to_analyse'].append(root_folder+'v4-uct/MFRL/TS-de4')

# settings['folders_to_analyse'].append(root_folder+'v4-uct/UCT/HRI-2')
settings['folders_to_analyse'].append(root_folder+'v4-uct/UCT/HRI-3')
settings['folders_to_analyse'].append(root_folder+'v4-uct/UCT/RC-6')
# settings['folders_to_analyse'].append(root_folder+'v4-uct/UCT-release/RC-6')
settings['folders_to_analyse'].append(root_folder+'v4-uct/UCT/TF-d2')
settings['folders_to_analyse'].append(root_folder+'v4-uct/UCT-release/TS-de4')

# settings['folders_to_analyse'] = [folder for folder in settings['folders_to_analyse'] if 'HRI-1' in folder]
...
settings['legend_labels'] = [
    ...
    r'THTS (learned)',                        # baseline

    r'LQ-RRL',                                   # baseline
    r'RRL + Dyna',                            # baseline

    # r'UCT ($\Lambda = 0$)',                 # semihybrid
    # r'UCT ($\Lambda = 0.5$)']               # hybrid
...
settings['plot_settings'] = {
    ...
    'reorder_by_legend': {
        'default': [
            ['Ground-Truth', 'PROST~15'],
            ['Learned', 'PROST~15'],

            ['Double_Q-Learning2', 'FA=LFA-ALL_L2SPN', 'Import-Qfunction=True', 'SP=disabled'],
            ['Double_Q-Learning2', 'FA=LFA-ALL_L2SPN', 'Import-Qfunction=True', 'SP={500, 40}'],

            # ['MDL=Dbn', 'Learned', 'Double_Q-Learning2', 'FA=LFA-ALL_L2SPN', 'Import-Qfunction=True', 'MPS=uct-hybrid', 'UCT~1.41421~15~60~10~', '~MF0.5~PRH0'],
            
            ['MDL=Dbn', 'Learned', 'Double_Q-Learning2', 'FA=LFA-ALL_L2SPN', 'Import-Qfunction=True', 'MPS=uct-hybrid', 'UCT~1.41421~15~5~10~', '~MF0.5~PRH5'],

            # this is if there is no other MPS
            # ['MDL=Dbn', 'Learned', 'Double_Q-Learning2', 'FA=LFA-ALL_L2SPN', 'Import-Qfunction=True', 'UCT~1.41421~15~5~10~', '~MF0.5~PRH5'],
            
            # ['MDL=Dbn', 'Learned', 'Double_Q-Learning2', 'FA=LFA-ALL_L2SPN', 'Import-Qfunction=True', 'MPS=uct-hybrid', 'UCT~1.41421~15~60~10~', '~MF0.5~PRH5'],
        ],
        'recon2_mdp': [
            ['Ground-Truth', 'PROST~15'],
            ['Learned', 'PROST~15'],

            ['Dual-Double_Q-Learning2', 'Import-Qfunction=True', 'SP=disabled'],
            ['Dual-Double_Q-Learning2', 'Import-Qfunction=True', 'SP={500, 40}'],

            # ['MDL=Dbn', 'Learned', 'Dual-Double_Q-Learning2~TLD', 'Import-Qfunction=True', 'UCT~1.41421~15~60~10~', '~MF0.5~PRH0'],
            ['MDL=Dbn', 'Learned', 'Dual-Double_Q-Learning2~TLD', 'Import-Qfunction=True', 'UCT~1.41421~15~5~10~', '~MF0.5~PRH5'],
            # ['MDL=Dbn', 'Learned', 'Dual-Double_Q-Learning2~TLD', 'Import-Qfunction=True', 'UCT~1.41421~15~60~10~', '~MF0.5~PRH5'],
        ],
        'turtlebot_survey_mdp': [
            ['Ground-Truth', 'PROST~15'],
            ['Learned', 'PROST~15'],

            ['Double_Q-Learning2', 'FA=LFA-ALL_L2SPN', 'Import-Qfunction=True', 'SP=disabled', 'LfD-FO-BP-TL'],
            ['Double_Q-Learning2', 'FA=LFA-ALL_L2SPN', 'Import-Qfunction=True', 'SP={500, 40}', 'LfD-FO-BP-TL'],

            # ['MDL=Dbn', 'Learned', 'Double_Q-Learning2', 'FA=LFA-ALL_L2SPN', 'Import-Qfunction=True', 'MPS=uct-hybrid', 'UCT~1.41421~15~60~10~', '~MF0.5~PRH0'],
            
            ['MDL=Dbn', 'Learned', 'Double_Q-Learning2', 'FA=LFA-ALL_L2SPN', 'Import-Qfunction=True', 'MPS=uct-hybrid', 'UCT~1.41421~15~5~10~', '~MF0.5~PRH5', 'LfD-FO-BP-TL'],
        ...
        'tiago_fetch_mdp': [
            ...
            # ['MDL=Dbn', 'Learned', 'Dual-Double_Q-Learning2~TLD', 'Import-Qfunction=True', 'MPS=uct-hybrid', 'UCT~1.41421~15~60~10~', '~MF0.5~PRH0'],
            ['MDL=Dbn', 'Learned', 'Dual-Double_Q-Learning2~TLD', 'Import-Qfunction=True', 'MPS=uct-hybrid', 'UCT~1.41421~15~5~10~', '~MF0.5~PRH5'],
            # ['MDL=Dbn', 'Learned', 'Dual-Double_Q-Learning2~TLD', 'Import-Qfunction=True', 'MPS=uct-hybrid', 'UCT~1.41421~15~60~10~', '~MF0.5~PRH5'],
        ],
        'tiago_hri_mdp': [
            ['Ground-Truth', 'PROST~10'],   # PROST~15 is very poor
            ['Learned', 'PROST~15'],

            ['Double_Q-Learning2', 'FA=LFA-ALL_L2SPN', 'Import-Qfunction=True', 'SP=disabled'],
            ['Double_Q-Learning2', 'FA=LFA-ALL_L2SPN', 'Import-Qfunction=True', 'SP={500, 40}'],

            ['MDL=Dbn', 'Learned', 'Double_Q-Learning2', 'FA=LFA-ALL_L2SPN', 'UCT~1.41421~15~60~10~', '~MF0.5~PRH0'],
            # ['MDL=Dbn', 'Learned', 'Double_Q-Learning2', 'FA=LFA-ALL_L2SPN', 'UCT~1.41421~15~5~10~', '~MF0.5~PRH5'],
            # ['MDL=Dbn', 'Learned', 'Double_Q-Learning2', 'FA=LFA-ALL_L2SPN', 'UCT~1.41421~15~60~10~', '~MF0.5~PRH5'],
        ],
    },
