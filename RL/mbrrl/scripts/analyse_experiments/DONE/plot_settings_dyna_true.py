...
# settings['folders_to_analyse'].append(root_folder+'v1-generalised-learning/DYNA/DYNA-true-500/AA-5')
settings['folders_to_analyse'].append(root_folder+'v1-generalised-learning/DYNA/DYNA-true-500/HRI-1')
# settings['folders_to_analyse'].append(root_folder+'v1-generalised-learning/DYNA/DYNA-true-500/RC-6')
# settings['folders_to_analyse'].append(root_folder+'v1-generalised-learning/DYNA/DYNA-true-500/TF-d2')
# settings['folders_to_analyse'].append(root_folder+'v1-generalised-learning/DYNA/DYNA-true-500/TS-de4')
# settings['folders_to_analyse'].append(root_folder+'v1-generalised-learning/DYNA/DYNA-true-500/TT-6')
...
# settings['folders_to_analyse'].append(root_folder+'v1-generalised-learning/DYNA/DYNA-true-3000/AA-5')
settings['folders_to_analyse'].append(root_folder+'v1-generalised-learning/DYNA/DYNA-true-3000/HRI-1')
# settings['folders_to_analyse'].append(root_folder+'v1-generalised-learning/DYNA/DYNA-true-3000/RC-6')
# settings['folders_to_analyse'].append(root_folder+'v1-generalised-learning/DYNA/DYNA-true-3000/TF-d2')
# settings['folders_to_analyse'].append(root_folder+'v1-generalised-learning/DYNA/DYNA-true-3000/TS-de4')
# settings['folders_to_analyse'].append(root_folder+'v1-generalised-learning/DYNA/DYNA-true-3000/TT-6')

# settings['folders_to_analyse'].append(root_folder+'v1-generalised-learning/DYNA/vanilla/AA-5')
# settings['folders_to_analyse'].append(root_folder+'v1-generalised-learning/DYNA/vanilla/HRI-1')
# settings['folders_to_analyse'].append(root_folder+'v1-generalised-learning/DYNA/vanilla/RC-6')
# settings['folders_to_analyse'].append(root_folder+'v1-generalised-learning/DYNA/vanilla/TF-d2')
# settings['folders_to_analyse'].append(root_folder+'v1-generalised-learning/DYNA/vanilla/TS-de4')
# settings['folders_to_analyse'].append(root_folder+'v1-generalised-learning/DYNA/vanilla/TT-6')
...
settings['plot_settings'] = {
    ...
    'reorder_by_legend': {
        'default': [
            # ['MDL=List', 'FA=N', 'SP=disabled'],
            # ['MDL=Dbn', 'FA=N', 'SP={-1, -5}'],
            # ['MDL=Dbn', 'FA=N', 'SP={500, 40}'],
            # ['MDL=Dbn', 'FA=N', 'SP={1000, 40}'],
            # ['MDL=Dbn', 'FA=N', 'SP={3000, 40}'],

            ['MDL=List', 'FA=L2SPN (CX', 'SP=disabled'],
            # ['MDL=Dbn', 'FA=L2SPN (CX', 'SP={-1, -5}'],
            ['MDL=Dbn', 'FA=L2SPN (CX', 'SP={500, 40}'],
            ['MDL=Dbn', 'FA=L2SPN (CX', 'SP={1000, 40}'],
            ['MDL=Dbn', 'FA=L2SPN (CX', 'SP={3000, 40}'],
            '',
        ],
        'tiago_hri': [
            # ['Latent', 'MDL=List', 'FA=N', 'SP=disabled'],
            # ['Latent', 'MDL=Dbn', 'FA=N', 'SP={-1, -5}'],
            # ['Latent', 'MDL=Dbn', 'FA=N', 'SP={500, 40}'],
            # ['Latent', 'MDL=Dbn', 'FA=N', 'SP={1000, 40}'],
            # ['Latent', 'MDL=Dbn', 'FA=N', 'SP={3000, 40}'],

            ['Latent', 'MDL=List', 'FA=L2SPN (CX', 'SP=disabled'],
            # ['Latent', 'MDL=Dbn', 'FA=L2SPN (CX', 'SP={-1, -5}'],
            ['Latent', 'MDL=Dbn', 'FA=L2SPN (CX', 'SP={500, 40}'],
            ['Latent', 'MDL=Dbn', 'FA=L2SPN (CX', 'SP={1000, 40}'],
            ['Latent', 'MDL=Dbn', 'FA=L2SPN (CX', 'SP={3000, 40}'],
            ['Ground-Truth', 'MDL=Dbn', 'FA=L2SPN (CX', 'SP={3000, 40}'],
        ]
    },
