...
settings['folders_to_analyse'].append(root_folder+'v1-generalised-learning/intrinsic/other-policy/AA-5')
settings['folders_to_analyse'].append(root_folder+'v1-generalised-learning/intrinsic/other-policy/HRI-1')
settings['folders_to_analyse'].append(root_folder+'v1-generalised-learning/intrinsic/other-policy/RC-6')
settings['folders_to_analyse'].append(root_folder+'v1-generalised-learning/intrinsic/other-policy/TF-d2')
settings['folders_to_analyse'].append(root_folder+'v1-generalised-learning/intrinsic/other-policy/TS-de4')
settings['folders_to_analyse'].append(root_folder+'v1-generalised-learning/intrinsic/other-policy/TT-6')
...
settings['legend_labels'] = [
        ...
        r'Softmax',
        r'Greedy',
        r'$\epsilon$-$greedy$ ($\epsilon = 1$)',
        r'$\epsilon$-$greedy$ ($\epsilon = 0.5$)',
        r'$Greedy$-$\epsilon$-$greedy$']
y_lim = None
# y_lim = (-300, -100, 50)
...
settings['plot_settings'] = {
    ...
    'reorder_by_legend': [
        ...
        ['other-policy', 'FA=L2SPN', ' Softmax', 'IR=td_error'],
        ['other-policy', 'FA=L2SPN', ' Greedy', 'IR=td_error'],
        ['other-policy', 'FA=L2SPN', ' Epsilon-Greedy', 'Epsilon=1.0', 'IR=td_error'],
        ['other-policy', 'FA=L2SPN', ' Epsilon-Greedy', 'Epsilon=0.5', 'IR=td_error'],
        ['FA=L2SPN', ' Epsilon-Greedy', 'IR=td_error']
    ],
