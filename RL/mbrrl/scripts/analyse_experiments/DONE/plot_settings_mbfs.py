...
settings['folders_to_analyse'].append(root_folder+'v1-generalised-learning/MBFS/true-model/HRI-1')
settings['folders_to_analyse'].append(root_folder+'v1-generalised-learning/MBFS/true-model/RC-6')
settings['folders_to_analyse'].append(root_folder+'v1-generalised-learning/MBFS/true-model/TF-d2')
settings['folders_to_analyse'].append(root_folder+'v1-generalised-learning/MBFS/true-model/TS-de4')

settings['folders_to_analyse'].append(root_folder+'v1-generalised-learning/MBFS/learned-model/HRI-1')
settings['folders_to_analyse'].append(root_folder+'v1-generalised-learning/MBFS/learned-model/RC-6')
settings['folders_to_analyse'].append(root_folder+'v1-generalised-learning/MBFS/learned-model/TF-d2')
settings['folders_to_analyse'].append(root_folder+'v1-generalised-learning/MBFS/learned-model/TS-de4')
...
if OPTION == 1:
    ...
    settings['folders_to_analyse'].append(root_folder+'v1-generalised-learning/MBFS/true-model/AA-5')
    settings['folders_to_analyse'].append(root_folder+'v1-generalised-learning/MBFS/true-model/TT-6')
...
if OPTION == 1:
    settings['legend_labels'] = [
        r'$\widetilde{Q}^{gnd}$ (MFFS)',
        r'$\widetilde{Q}^{gnd}$ (MBFS, $\nu=2$)',
        r'$\widetilde{Q}^{gnd}$ (MBFS, $\nu=3$)',
        r'$\widetilde{Q}^{fo}$ (MFFS)',
        r'$\widetilde{Q}^{fo}$ (MBFS, $\nu=2$)',
        r'$\widetilde{Q}^{fo}$ (MBFS, $\nu=3$)']
    ...
    reorder_by_legend = [
        ...
        ['Learned', 'FA=CPF3_N'],
        'FA=CPF2_L2SPN',
        ['Learned', 'FA=CPF2_L2SPN'],
        'FA=CPF3_L2SPN',
        ['Learned', 'FA=CPF3_L2SPN'],
    ]
y_lim = None
# y_lim = (-300, -100, 50)
...
settings['plot_settings'] = {
    ...
    'sci': False,            # if true, use scientific ticks for y axis
    'show_title': False,
    'show_fig': False,
    'show_grid': False,
    'show_legend': False,
