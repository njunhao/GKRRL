...
# rerun combination for AA and TF because results not good
...
if OPTION == 1:
    reorder_by_legend = [
        ['EXP=List', 'FA=N', 'IR=disabled'],
        ['EXP=List', 'FA=N', 'IR=visit_count '],
        ['EXP=List', 'FA=N', 'IR=visit_count_lfa '],
        ['EXP=List', 'FA=N', 'IR=td_error '],
        # ['EXP=List', 'FA=N', 'IR=delta_td_error '],
        ['EXP=List', 'FA=N', 'IR=dowham '],
        ['EXP=List', 'FA=N', 'IR=goal_trajectory '],
        # ['EXP=List', 'FA=N', 'IR=dowham+goal_trajectory+td_error+visit_count'],
    ]
elif OPTION == 2:
    reorder_by_legend = [
        ['EXP=List', 'FA=L2SPN', 'IR=disabled'],
        ['EXP=List', 'FA=L2SPN', 'IR=visit_count '],
        ['EXP=List', 'FA=L2SPN', 'IR=visit_count_lfa '],
        ['EXP=List', 'FA=L2SPN', 'IR=td_error '],
        # ['EXP=List', 'FA=L2SPN', 'IR=delta_td_error '],
        ['EXP=List', 'FA=L2SPN', 'IR=dowham '],
        ['EXP=List', 'FA=L2SPN', 'IR=goal_trajectory '],
        # ['EXP=List', 'FA=L2SPN', 'IR=dowham+goal_trajectory+td_error+visit_count'],
    ]
y_lim = None
# y_lim = (-300, -100, 50)
