...
settings['folders_to_analyse'].append(root_folder+'v1-generalised-learning/intrinsic/beta-001/AA-5')
settings['folders_to_analyse'].append(root_folder+'v1-generalised-learning/intrinsic/beta-001/HRI-1')
settings['folders_to_analyse'].append(root_folder+'v1-generalised-learning/intrinsic/beta-001/RC-6')
settings['folders_to_analyse'].append(root_folder+'v1-generalised-learning/intrinsic/beta-001/TF-d2')
settings['folders_to_analyse'].append(root_folder+'v1-generalised-learning/intrinsic/beta-001/TS-de4')
settings['folders_to_analyse'].append(root_folder+'v1-generalised-learning/intrinsic/beta-001/TT-6')

settings['folders_to_analyse'].append(root_folder+'v1-generalised-learning/intrinsic/beta-005/AA-5')
settings['folders_to_analyse'].append(root_folder+'v1-generalised-learning/intrinsic/beta-005/HRI-1')
settings['folders_to_analyse'].append(root_folder+'v1-generalised-learning/intrinsic/beta-005/RC-6')
settings['folders_to_analyse'].append(root_folder+'v1-generalised-learning/intrinsic/beta-005/TF-d2')
settings['folders_to_analyse'].append(root_folder+'v1-generalised-learning/intrinsic/beta-005/TS-de4')
settings['folders_to_analyse'].append(root_folder+'v1-generalised-learning/intrinsic/beta-005/TT-6')
...
settings['folders_to_analyse'].append(root_folder+'v1-generalised-learning/intrinsic/beta-05/AA-5')
settings['folders_to_analyse'].append(root_folder+'v1-generalised-learning/intrinsic/beta-05/HRI-1')
settings['folders_to_analyse'].append(root_folder+'v1-generalised-learning/intrinsic/beta-05/RC-6')
settings['folders_to_analyse'].append(root_folder+'v1-generalised-learning/intrinsic/beta-05/TF-d2')
settings['folders_to_analyse'].append(root_folder+'v1-generalised-learning/intrinsic/beta-05/TS-de4')
settings['folders_to_analyse'].append(root_folder+'v1-generalised-learning/intrinsic/beta-05/TT-6')

settings['folders_to_analyse'].append(root_folder+'v1-generalised-learning/intrinsic/decay/AA-5')
settings['folders_to_analyse'].append(root_folder+'v1-generalised-learning/intrinsic/decay/HRI-1')
settings['folders_to_analyse'].append(root_folder+'v1-generalised-learning/intrinsic/decay/RC-6')
settings['folders_to_analyse'].append(root_folder+'v1-generalised-learning/intrinsic/decay/TF-d2')
settings['folders_to_analyse'].append(root_folder+'v1-generalised-learning/intrinsic/decay/TS-de4')
settings['folders_to_analyse'].append(root_folder+'v1-generalised-learning/intrinsic/decay/TT-6')
...
settings['plot_settings'] = {
    ...
    # 'reorder_by_legend': [
    #     ['FA=N, FL=iFDD+ (tau=', 'IR=disabled'],
    #     ['FA=N, FL=iFDD+ (tau=', 'IR=td_error (IR-Rmax', 'beta=0.01, beta-decay=1, Agg=average)'],
    #     ['FA=N, FL=iFDD+ (tau=', 'IR=td_error (IR-Rmax', 'beta=0.05, beta-decay=1, Agg=average)'],
    #     ['FA=N, FL=iFDD+ (tau=', 'IR=td_error (IR-Rmax', 'beta=0.1, beta-decay=1, Agg=average)'],
    #     ['FA=N, FL=iFDD+ (tau=', 'IR=td_error (IR-Rmax', 'beta=0.5, beta-decay=1, Agg=average)'],
    #     ['FA=N, FL=iFDD+ (tau=', 'IR=td_error (IR-Rmax', 'beta=1, beta-decay=0.95, Agg=average)'],
    # ],
    'reorder_by_legend': [
        ['FA=L2SPN', 'FL=iFDD+ (tau=', 'IR=disabled'],
        ['FA=L2SPN', 'FL=iFDD+ (tau=', 'IR=td_error (IR-Rmax', 'beta=0.01, beta-decay=1, Agg=average)'],
        ['FA=L2SPN', 'FL=iFDD+ (tau=', 'IR=td_error (IR-Rmax', 'beta=0.05, beta-decay=1, Agg=average)'],
        ['FA=L2SPN', 'FL=iFDD+ (tau=', 'IR=td_error (IR-Rmax', 'beta=0.1, beta-decay=1, Agg=average)'],
        ['FA=L2SPN', 'FL=iFDD+ (tau=', 'IR=td_error (IR-Rmax', 'beta=0.5, beta-decay=1, Agg=average)'],
        ['FA=L2SPN', 'FL=iFDD+ (tau=', 'IR=td_error (IR-Rmax', 'beta=1, beta-decay=0.95, Agg=average)'],
    ],
    # 'reorder_by_legend': [
    #     ['EXP=List', 'FA=L2SPN', 'FL=iFDD+ (tau=', 'IR=disabled'],
    #     ['EXP=List', 'FA=L2SPN', 'FL=iFDD+ (tau=', 'IR=visit_count (IR-Rmax', 'beta=0.01, beta-decay=1, Agg=average)'],
    #     ['EXP=List', 'FA=L2SPN', 'FL=iFDD+ (tau=', 'IR=visit_count (IR-Rmax', 'beta=0.05, beta-decay=1, Agg=average)'],
    #     ['EXP=List', 'FA=L2SPN', 'FL=iFDD+ (tau=', 'IR=visit_count (IR-Rmax', 'beta=0.1, beta-decay=1, Agg=average)'],
    #     ['EXP=List', 'FA=L2SPN', 'FL=iFDD+ (tau=', 'IR=visit_count (IR-Rmax', 'beta=0.5, beta-decay=1, Agg=average)'],
    #     ['EXP=List', 'FA=L2SPN', 'FL=iFDD+ (tau=', 'IR=visit_count (IR-Rmax', 'beta=1, beta-decay=0.95, Agg=average)'],
    # ],
