...
settings['folders_to_analyse'].append(root_folder+'v0-first-order-lfa/MFFS/sensitivity-tau/AA-5')
...
settings['folders_to_analyse'].append(root_folder+'v0-first-order-lfa/MFFS/sensitivity-tau/RC-6')
...
settings['folders_to_analyse'].append(root_folder+'v0-first-order-lfa/MFFS/sensitivity-tau/TS-de4')
...
settings['folders_to_analyse'].append(root_folder+'v0-first-order-lfa/MFFS/sensitivity-tau/TT-6')
...
settings['folders_to_analyse'].append(root_folder+'v0-first-order-lfa/MFFS/sensitivity-tau/TF-d2')
...
settings['folders_to_analyse'].append(root_folder+'v0-first-order-lfa/MFFS/sensitivity-tau/HRI-1')
...
settings['legend_labels'] = [
    r'$\widetilde{Q}^{gnd} \, (\tau=1)$',
    r'$\widetilde{Q}^{gnd} \, (\tau=5)$',
    r'$\widetilde{Q}^{gnd} \, (\tau=10)$',
    r'$\widetilde{Q}^{gnd} \, (\tau=20)$',
    r'$\widetilde{Q}^{fo} \, (\tau=1)$',
    r'$\widetilde{Q}^{fo} \, (\tau=5)$',
    r'$\widetilde{Q}^{fo} \, (\tau=10)$',
    r'$\widetilde{Q}^{fo} \, (\tau=20)$']
y_lim = None
# y_lim = (-300, -100, 50)
...
settings['plot_settings'] = {
    ...
    'reorder_by_legend': {
        ...
        'recon2_mdp': [
            'sensitivity-tau, FA=N, FL=iFDD+ (tau=1), MQTE=3',
            'MQTE_RC-6, FA=N, FL=iFDD+ (tau=5), MQTE=0',
            'sensitivity-tau, FA=N, FL=iFDD+ (tau=11), MQTE=3',
            'sensitivity-tau, FA=N, FL=iFDD+ (tau=22), MQTE=3',
            'sensitivity-tau, FA=L2SPN (CX-Loc-Gnd-Goal, OR), FL=iFDD+ (tau=1), MQTE=3',
            'MQTE_RC-6, FA=L2SPN (CX-Loc-Gnd-Goal, OR), FL=iFDD+ (tau=2), MQTE=3',
            'sensitivity-tau, FA=L2SPN (CX-Loc-Gnd-Goal, OR), FL=iFDD+ (tau=5), MQTE=3',
            'sensitivity-tau, FA=L2SPN (CX-Loc-Gnd-Goal, OR), FL=iFDD+ (tau=10), MQTE=3',
        ],
        'tiago_hri_mdp': [
            'sensitivity-tau, FA=N, FL=iFDD+ (tau=1)',
            'adaptive-nil_HRI-1, FA=N, FL=iFDD+ (tau=5)',
            'sensitivity-tau, FA=N, FL=iFDD+ (tau=10)',
            'sensitivity-tau, FA=N, FL=iFDD+ (tau=21)',
            'sensitivity-tau, FA=L2SPN (CX-Gnd-Goal, OR), FL=iFDD+ (tau=1)',
            'adaptive-nil, FA=L2SPN (CX-Gnd-Goal, OR), FL=iFDD+ (tau=2)',
            'sensitivity-tau, FA=L2SPN (CX-Gnd-Goal, OR), FL=iFDD+ (tau=4)',
            'sensitivity-tau, FA=L2SPN (CX-Gnd-Goal, OR), FL=iFDD+ (tau=8)',
        ],
        'tiago_fetch_mdp': [
            'sensitivity-tau, FA=N, FL=iFDD+ (tau=1)',
            'adaptive-nil_TF-d2, FA=N, FL=iFDD+ (tau=8)',
            'sensitivity-tau, FA=N, FL=iFDD+ (tau=16)',
            'sensitivity-tau, FA=N, FL=iFDD+ (tau=33)',
            'sensitivity-tau, FA=L2SPN (CX-Gnd-Goal, OR), FL=iFDD+ (tau=1)',
            'adaptive-nil, FA=L2SPN (CX-Gnd-Goal, OR), FL=iFDD+ (tau=1)',
            'sensitivity-tau, FA=L2SPN (CX-Gnd-Goal, OR), FL=iFDD+ (tau=3)',
            'sensitivity-tau, FA=L2SPN (CX-Gnd-Goal, OR), FL=iFDD+ (tau=6)',
        ],
        'triangle_tireworld_mdp': [
            'sensitivity-tau, FA=N, FL=iFDD+ (tau=1)',
            'adaptive-nil_TT-6, FA=N, FL=iFDD+ (tau=5)',
            'sensitivity-tau, FA=N, FL=iFDD+ (tau=11)',
            'sensitivity-tau, FA=N, FL=iFDD+ (tau=23)',
            'sensitivity-tau, FA=L2SPN (CX-Loc, OR), FL=iFDD+ (tau=1)',
            'adaptive-nil_TT-6, FA=L2SPN (CX-Goal, OR), FL=iFDD+ (tau=1)',
            'sensitivity-tau, FA=L2SPN (CX-Loc, OR), FL=iFDD+ (tau=3)',
            'sensitivity-tau, FA=L2SPN (CX-Loc, OR), FL=iFDD+ (tau=6)',
        ],
        'turtlebot_survey_mdp': [
            'sensitivity-tau, FA=N, FL=iFDD+ (tau=1)',
            'adaptive-nil_TS-de4, FA=N, FL=iFDD+ (tau=3)',
            'sensitivity-tau, FA=N, FL=iFDD+ (tau=6)',
            'sensitivity-tau, FA=N, FL=iFDD+ (tau=13)',
            'sensitivity-tau, FA=L2SPN (CX-Loc-Gnd-Goal, OR), FL=iFDD+ (tau=1)',
            'adaptive-nil_TS-de4, FA=L2SPN (CX-Loc-Gnd-Goal, OR), FL=iFDD+ (tau=1)',
            'sensitivity-tau, FA=L2SPN (CX-Loc-Gnd-Goal, OR), FL=iFDD+ (tau=3)',
            'sensitivity-tau, FA=L2SPN (CX-Loc-Gnd-Goal, OR), FL=iFDD+ (tau=6)',
        ],
    },
