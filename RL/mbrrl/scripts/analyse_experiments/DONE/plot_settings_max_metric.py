...
benchmark_folders = {
    ...
    'recon2':                   [(root_folder+'v0-first-order-lfa/MQTE/RC-6/', list(range(1, 11))), (root_folder+'v0-first-order-lfa/MFFS/adaptive-nil/RC-6/', list(range(21, 31)))],
...
settings['folders_to_analyse'].append(root_folder+'v0-first-order-lfa/MFFS/specific-best/AA-5')
settings['folders_to_analyse'].append(root_folder+'v0-first-order-lfa/MFFS/specific-best/HRI-1')
settings['folders_to_analyse'].append(root_folder+'v0-first-order-lfa/MFFS/specific-best/RC-6')
# settings['folders_to_analyse'].append(root_folder+'v0-first-order-lfa/MFFS/specific-best/RC-6')
settings['folders_to_analyse'].append(root_folder+'v0-first-order-lfa/MFFS/specific-best/TF-d2')
settings['folders_to_analyse'].append(root_folder+'v0-first-order-lfa/MFFS/specific-best/TS-de4')
settings['folders_to_analyse'].append(root_folder+'v0-first-order-lfa/MFFS/specific-best/TT-6')

settings['folders_to_analyse'].append(root_folder+'v0-first-order-lfa/MFFS/state-best/AA-5')
settings['folders_to_analyse'].append(root_folder+'v0-first-order-lfa/MFFS/state-best/HRI-1')
settings['folders_to_analyse'].append(root_folder+'v0-first-order-lfa/MFFS/state-best/RC-6')
# settings['folders_to_analyse'].append(root_folder+'v0-first-order-lfa/MFFS/state-best/RC-6')
settings['folders_to_analyse'].append(root_folder+'v0-first-order-lfa/MFFS/state-best/TF-d2')
settings['folders_to_analyse'].append(root_folder+'v0-first-order-lfa/MFFS/state-best/TS-de4')
settings['folders_to_analyse'].append(root_folder+'v0-first-order-lfa/MFFS/state-best/TT-6')
