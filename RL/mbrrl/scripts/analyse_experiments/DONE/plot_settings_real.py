...
benchmark_folders = {
    ...
    'tiago_hri3':               [(root_folder+'v0-first-order-lfa/MFFS/adaptive-nil/HRI-3/', list(range(11, 21))), (root_folder+'v0-first-order-lfa/MFFS/adaptive-nil/HRI-3/', list(range(31, 41)))],
}
...
if OPTION == 1:
    ...
    settings['folders_to_analyse'].append(root_folder+'v4-uct/TDORMDP/HRI-1')
else:
    settings['folders_to_analyse'].append(benchmark_folders['tiago_hri3'][0])
    settings['folders_to_analyse'].append(benchmark_folders['tiago_hri3'][1])
    settings['folders_to_analyse'].append(root_folder+'v0-first-order-lfa/PRL/HRI-3')
    settings['folders_to_analyse'].append(root_folder+'v4-uct/TDORMDP/HRI-3')
...
# settings['legend_labels'] = [
#     r'$P^{SR3}_{\varnothing}$',
#     r'$P^{SR3}_{TDO}$',
#     r'$P^{SR1}_{\varnothing} \rightarrow P^{SR3}_{\varnothing}$',
#     r'$P^{SR1}_{\varnothing} \rightarrow P^{SR3}_{DO}$',
#     r'$P^{SR1}_{\varnothing} \rightarrow P^{SR3}_{T}$',
#     r'$P^{SR1}_{\varnothing} \rightarrow P^{SR3}_{TDO}$',
#     # r'$P^{SR1}_{\varnothing} \rightarrow P^{SR3}_{TDO}$ (Dyna)'
# ]
settings['legend_labels'] = [
    r'$P_{\varnothing}$',
    # r'$P_{DO}$',
    r'$P_{TDO}$',
    r'$P^{SR1}_{\varnothing} \rightarrow P_{\varnothing}$',
    r'$P^{SR1}_{\varnothing} \rightarrow P_{DO}$',
    r'$P^{SR1}_{\varnothing} \rightarrow P_{T}$',
    r'$P^{SR1}_{\varnothing} \rightarrow P_{TDO}$',
    # r'$P^{SR1}_{\varnothing} \rightarrow P^{SR3}_{TDO}$ (Dyna)'
]
y_lim = None
if OPTION == 1:
    reorder_by_legend = [
        'FA=L2SPN (CX-Gnd-Goal-Loc, OR), FL=iFDD+ (tau=2), Epsilon=1.0',
        ['Latent-Obj=True', 'Dyn-C=300.0', 'FA=L2SPN (CX-Gnd-Goal-Loc, OR), FL=iFDD+ (tau=2), Epsilon=1.0'],
        'N/A',
        ['Latent-Obj=True', 'FA=L2SPN (CX-Gnd-Goal-Loc, OR), FL=iFDD+ (tau=2), Epsilon=0.2, Import-Qfunction=True'],
        ['Dyn-C=300.0', 'FA=L2SPN (CX-Gnd-Goal-Loc, OR), FL=iFDD+ (tau=2), Epsilon=0.2, Import-Qfunction=True'],
        ['Latent-Obj=True', 'Dyn-C=300.0', 'FA=L2SPN (CX-Gnd-Goal-Loc, OR), FL=iFDD+ (tau=2), Epsilon=0.2, Import-Qfunction=True'],
    ]
else:
    reorder_by_legend = [
        ['Double_Q-Learning2', 'FA=LFA-ALL_L2SPN (CX-Gnd-Goal-Loc, OR), FL=iFDD+ (SL, zeta=0.1, I=0, M=3, tau=2)', 'Epsilon-Greedy', 'Epsilon=1.0'],
        # ['Latent-Obj=True', 'Double_Q-Learning2', 'FA=LFA-ALL_L2SPN (CX-Gnd-Goal-Loc-CRL2, OR)', 'FL=iFDD+ (SL, zeta=0.1, I=0, M=3, tau=2)', 'Epsilon-Greedy', 'Epsilon=1.0'],
        ['Latent-Obj=True', 'Dyn-C=300.0', 'Double_Q-Learning2', 'FA=LFA-ALL_L2SPN (CX-Gnd-Goal-Loc, OR)', 'FL=iFDD+ (SL, zeta=0.1, I=0, M=3, tau=2)', 'Epsilon-Greedy', 'Epsilon=1.0'],
        ['Double_Q-Learning2', 'FA=LFA-ALL_L2SPN (CX-Gnd-Goal-Loc, OR)', 'FL=iFDD+ (SL, zeta=0.1, I=0, M=3, tau=2)', 'Epsilon-Greedy', 'Epsilon=0.2', 'Import-Qfunction=True'],
        ['Latent-Obj=True', 'Double_Q-Learning2', 'FA=LFA-ALL_L2SPN (CX-Gnd-Goal-Loc, OR)', 'FL=iFDD+ (SL, zeta=0.1, I=0, M=3, tau=2)', 'Epsilon-Greedy', 'Epsilon=0.2', 'Import-Qfunction=True'],
        ['Dyn-C=300.0', 'Double_Q-Learning2', 'FA=LFA-ALL_L2SPN (CX-Gnd-Goal-Loc, OR)', 'FL=iFDD+ (SL, zeta=0.1, I=0, M=3, tau=2)', 'Epsilon-Greedy', 'Epsilon=0.2', 'Import-Qfunction=True'],
        ['Latent-Obj=True', 'Dyn-C=300.0', 'Double_Q-Learning2', 'FA=LFA-ALL_L2SPN (CX-Gnd-Goal-Loc, OR)', 'FL=iFDD+ (SL, zeta=0.1, I=0, M=3, tau=2)', 'Epsilon-Greedy', 'Epsilon=0.2', 'Import-Qfunction=True'],
        # 'MDL=List, Latent, Double_Q-Learning2, FA=LFA-ALL_L2SPN (CX-Gnd-Goal-Loc, OR), FL=iFDD+ (SL, zeta=0.1, I=0, M=3, tau=2), Epsilon-Greedy, Epsilon=1.0, SP=disabled',
        # 'MDL=List, Latent, Latent-Obj=True, Dyn-C=300.0, Double_Q-Learning2, FA=LFA-ALL_L2SPN (CX-Gnd-Goal-Loc, OR), FL=iFDD+ (SL, zeta=0.1, I=0, M=3, tau=2), Epsilon-Greedy, Epsilon=1.0, SP=disabled',
        # 'MDL=List, Latent, Double_Q-Learning2, FA=LFA-ALL_L2SPN (CX-Gnd-Goal-Loc, OR), FL=iFDD+ (SL, zeta=0.1, I=0, M=3, tau=2), Epsilon-Greedy, Epsilon=0.2, Import-Qfunction=True, SP=disabled',
        # 'MDL=List, Latent, Latent-Obj=True, Double_Q-Learning2, FA=LFA-ALL_L2SPN (CX-Gnd-Goal-Loc, OR), FL=iFDD+ (SL, zeta=0.1, I=0, M=3, tau=2), Epsilon-Greedy, Epsilon=0.2, Import-Qfunction=True, SP=disabled',
        # 'MDL=List, Latent, Dyn-C=300.0, Double_Q-Learning2, FA=LFA-ALL_L2SPN (CX-Gnd-Goal-Loc, OR), FL=iFDD+ (SL, zeta=0.1, I=0, M=3, tau=2), Epsilon-Greedy, Epsilon=0.2, Import-Qfunction=True, SP=disabled',
        # 'MDL=List, Latent, Latent-Obj=True, Dyn-C=300.0, Double_Q-Learning2, FA=LFA-ALL_L2SPN (CX-Gnd-Goal-Loc, OR), FL=iFDD+ (SL, zeta=0.1, I=0, M=3, tau=2), Epsilon-Greedy, Epsilon=0.2, Import-Qfunction=True, SP=disabled',
        # 'MDL=Dbn, Learned, Latent-Obj=True, Dyn-C=300.0, Double_Q-Learning2, FA=LFA-ALL_L2SPN (CX-Gnd-Goal-Loc, OR), FL=iFDD+ (SL, zeta=0.1, I=0, M=3, tau=2), Epsilon-Greedy, Epsilon=0.2, Import-Qfunction=True, SP={1000, 40}',
    ]
# y_lim = (-300, -100, 50)
