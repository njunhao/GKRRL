...
settings['folders_to_analyse'].append(root_folder+'v0-first-order-lfa/PRL/TS-de4')
...
settings['legend_labels'] = [
    r'$\widetilde{Q}^{gnd}$',                                              # no transfer learning (baseline)
    r'$\widetilde{Q}^{fo}$',                                               # no transfer learning (baseline)
    r'$\widetilde{Q}^{gnd} + \widetilde{Q}^{fo}$',                         # online RL with ensemble (baseline)
    # r'$\widetilde{Q}^{fo}_{\bot}$',                                      # knowledge transfer
    r'$\widetilde{Q}^{fo}_{\top}$',                                        # transfer learning
    r'$\widetilde{Q}^{gnd} + \widetilde{Q}^{fo}_{\bot}$ ($\pi_{switch}$)', # knowledge transfer with ensemble, switch policy
    r'$\widetilde{Q}^{gnd} + \widetilde{Q}^{fo}_{\bot}$ ($\pi_{sum}$)',    # knowledge transfer with ensemble, sum policy
    r'$\widetilde{Q}^{gnd} + \widetilde{Q}^{fo}_{\top}$ ($\pi_{sum}$)']    # transfer learning with ensemble, sum policy
y_lim = None
# y_lim = (-300, -100, 50)
...
settings['plot_settings'] = {
    ...
    'reorder_by_legend': {
        'default': [
            ['Double_Q-Learning2, FA=LFA-ALL_N, FL=iFDD+', 'Epsilon-Greedy'],
            ['Double_Q-Learning2, FA=LFA-ALL_L2SPN', 'Epsilon-Greedy'],
            ['Dual-Double_Q-Learning2~D, Epsilon-Greedy'],
            # ['Double_Q-Learning2, FA=LFA-ALL_L2SPN', ', Greedy', 'Import-Qfunction=True'],
            ['Double_Q-Learning2, FA=LFA-ALL_L2SPN', 'Epsilon-Greedy', 'Import-Qfunction=True'],
            ['Dual-Double_Q-Learning2~KTS, FA=LFA-ALL_N, FL=iFDD+', 'Epsilon-Greedy', 'Import-Qfunction=True'],
            ['Dual-Double_Q-Learning2~KTD, FA=LFA-ALL_N, FL=iFDD+', 'Epsilon-Greedy', 'Import-Qfunction=True'],
            ['Dual-Double_Q-Learning2~TLD, Epsilon-Greedy', 'Import-Qfunction=True'],
        ],
        'tiago_fetch_mdp': [
            ['Double_Q-Learning2, FA=LFA-ALL_N, FL=iFDD+'],
            ['Double_Q-Learning2, FA=LFA-ALL_L2SPN'],
            ['Dual-Double_Q-Learning2~D'],
            # 'dummy',
            ['Double_Q-Learning2, FA=LFA-ALL_L2SPN', 'Import-Qfunction=True'],
            ['Dual-Double_Q-Learning2~KTS, FA=LFA-ALL_N, FL=iFDD+', 'Import-Qfunction=True'],
            ['Dual-Double_Q-Learning2~KTD, FA=LFA-ALL_N, FL=iFDD+', 'Import-Qfunction=True'],
            ['Dual-Double_Q-Learning2~TLD', 'Import-Qfunction=True'],
        ],
        'tiago_hri_mdp': [
            ['Double_Q-Learning2, FA=LFA-ALL_N, FL=iFDD+'],
            ['Double_Q-Learning2, FA=LFA-ALL_L2SPN'],
