...
settings['folders_to_analyse'].append(root_folder+'/../ACE/nessie/STACK-RIBC-ON')
settings['folders_to_analyse'].append(root_folder+'/../ACE/nessie/STACK-RIBC-STACK')
settings['folders_to_analyse'].append(root_folder+'/../ACE/nessie/STACK-RIBC-UNSTACK')
settings['folders_to_analyse'].append(root_folder+'/../ACE/nessie/STACK-TG-ON')
settings['folders_to_analyse'].append(root_folder+'/../ACE/nessie/STACK-TG-STACK')
settings['folders_to_analyse'].append(root_folder+'/../ACE/nessie/STACK-TG-UNSTACK')
settings['folders_to_analyse'].append(root_folder+'/v6-resolution/BW/rpg')
...
settings['legend_labels'] = ['Ground', 'First-order', 'TG', 'RIB']
y_lim = None
# y_lim = (-300, -100, 50)
...
# settings['plot_options'].append(['time_taken', 'terminal', 'cross'])
...
settings['grouping_keys'] = []
settings['grouping_keys'].append(['domain', 'instance', 'num_episodes'])
