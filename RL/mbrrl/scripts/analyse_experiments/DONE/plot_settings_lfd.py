...
settings['folders_to_analyse'].append( (root_folder+'v1-generalised-learning/LfD/TT-6-lfd', list(range(1, 11))) )
settings['folders_to_analyse'].append( (root_folder+'v1-generalised-learning/LfD/TT-6-lfd', list(range(21, 31))) )
settings['folders_to_analyse'].append( (root_folder+'v1-generalised-learning/LfD/TS-de4-lfd', list(range(1, 11))) )
settings['folders_to_analyse'].append( (root_folder+'v1-generalised-learning/LfD/TS-de4-lfd', list(range(61, 71))) )
settings['folders_to_analyse'].append(root_folder+'v1-generalised-learning/LfD/TS-de4-lfd-ablation')
settings['folders_to_analyse'].append(root_folder+'v1-generalised-learning/LfD/TS-de4-lfd-transfer')
settings['folders_to_analyse'].append(root_folder+'v1-generalised-learning/LfD/TT-6-lfd-ablation')
settings['folders_to_analyse'].append(root_folder+'v1-generalised-learning/LfD/TT-6-lfd-transfer')
...
settings['plot_settings'] = {
    ...
    'reorder_by_legend': [
        ...
        ['FA=L2SPN (CX', '(LfD-BP)'],
        ['FA=L2SPN (CX', '(LfD-FO)'],
        ['FA=L2SPN (CX', '(LfD-FO-BP)'],
        ['FA=L2SPN (CX', '(LfD-FO-BP-TL)'],
    ],
