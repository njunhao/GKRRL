...
settings['folders_to_analyse'].append(root_folder+'v4-uct/unknown-precond/unknown-precond-large-scale')
settings['folders_to_analyse'].append(root_folder+'v4-uct/unknown-precond/unknown-precond-small-scale')

settings['folders_to_analyse'].append(root_folder+'v4-uct/unknown-precond/unknown-precond-v4/benchmark/HRI-1')
settings['folders_to_analyse'].append(root_folder+'v4-uct/unknown-precond/unknown-precond-v4/benchmark/RC-3')
settings['folders_to_analyse'].append(root_folder+'v4-uct/unknown-precond/unknown-precond-v4/benchmark/RC-6')
settings['folders_to_analyse'].append(root_folder+'v4-uct/unknown-precond/unknown-precond-v4/benchmark/TF-d1')
settings['folders_to_analyse'].append(root_folder+'v4-uct/unknown-precond/unknown-precond-v4/benchmark/TF-d2')
settings['folders_to_analyse'].append(root_folder+'v4-uct/unknown-precond/unknown-precond-v4/benchmark/TS-de2')
settings['folders_to_analyse'].append(root_folder+'v4-uct/unknown-precond/unknown-precond-v4/benchmark/TS-de2-lfd')
settings['folders_to_analyse'].append(root_folder+'v4-uct/unknown-precond/unknown-precond-v4/benchmark/TS-de4')
settings['folders_to_analyse'].append(root_folder+'v4-uct/unknown-precond/unknown-precond-v4/benchmark/TS-de4-lfd')

settings['folders_to_analyse'].append(root_folder+'v4-uct/unknown-precond/unknown-precond-v4/single-intrinsic/HRI-1')
settings['folders_to_analyse'].append(root_folder+'v4-uct/unknown-precond/unknown-precond-v4/single-intrinsic/RC-3')
settings['folders_to_analyse'].append(root_folder+'v4-uct/unknown-precond/unknown-precond-v4/single-intrinsic/RC-6')
settings['folders_to_analyse'].append(root_folder+'v4-uct/unknown-precond/unknown-precond-v4/single-intrinsic/TF-d1')
settings['folders_to_analyse'].append(root_folder+'v4-uct/unknown-precond/unknown-precond-v4/single-intrinsic/TF-d2')
settings['folders_to_analyse'].append(root_folder+'v4-uct/unknown-precond/unknown-precond-v4/single-intrinsic/TS-de2')
settings['folders_to_analyse'].append(root_folder+'v4-uct/unknown-precond/unknown-precond-v4/single-intrinsic/TS-de4')

settings['folders_to_analyse'].append(root_folder+'v4-uct/unknown-precond/unknown-precond-v4/combination-intrinsic/HRI-1')
settings['folders_to_analyse'].append(root_folder+'v4-uct/unknown-precond/unknown-precond-v4/combination-intrinsic/RC-3')
settings['folders_to_analyse'].append(root_folder+'v4-uct/unknown-precond/unknown-precond-v4/combination-intrinsic/RC-6')
settings['folders_to_analyse'].append(root_folder+'v4-uct/unknown-precond/unknown-precond-v4/combination-intrinsic/TF-d1')
settings['folders_to_analyse'].append(root_folder+'v4-uct/unknown-precond/unknown-precond-v4/combination-intrinsic/TF-d2')
settings['folders_to_analyse'].append(root_folder+'v4-uct/unknown-precond/unknown-precond-v4/combination-intrinsic/TS-de2')
settings['folders_to_analyse'].append(root_folder+'v4-uct/unknown-precond/unknown-precond-v4/combination-intrinsic/TS-de4')
...
settings['generic_plot_options'] = ['save', 'show_grid', 'save_legend_in_fig', 'show_title']
...
settings['plot_settings'] = {
    ...
    'reorder_by_legend': [
        ...
        # 'Learned, PROST~15',
        # 'Ground-Truth, UCT~1.41421~10~50~3~1000~RU',
        # 'Learned, UCT~1.41421~10~50~3~1000',
    ],
